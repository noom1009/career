...
?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="#"><?php echo iconv("tis-620", "UTF-8", $row->F_COMPANYCODE);?></a>
                                                        </td>
                                                        <td><?php echo iconv("tis-620", "UTF-8", $row->F_POSITIONNAME);?></td>
                                                        <td><?php echo iconv("tis-620", "UTF-8", $row->F_STATUSPOSITION);?></td> 
                                                        <td><?php echo iconv("tis-620", "UTF-8", $row->F_STATUS);?></td>  
