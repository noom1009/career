                         ...
                         <div class="page-content"> 
                            <div class="row">
                                                        <div class="col-sm-5 pull-right">                                                                                                    
                                                            <a href="<?php echo base_url();?>index.php/career/position_add">
                                                                <button class="btn btn-xs btn-danger pull-right">
                                                                    <span class="bigger-110">เพิ่มตำแหน่งงาน</span>

                                                                    <i class="ace-icon fa fa-floppy-o bigger-120 icon-on-right"></i>
                                                                </button>                                                         
                                                            </a>                                                                  
                                                        </div>
